...
class UNet(nn.Module):
    def __init__(
        ...
        # For graphs, we are not using typical image embeddings, but may include positional embeddings or time-related info
        ...
        self.mid = nn.ModuleList([  # Middle part with attention layers
